...
export default function IssueFeed() {
  ...
  const fetchIssues = useCallback(async () => {
    try {
      setIsLoading(true);
      const response = await issueService.getMyIssues(); // Ya service.getAllIssues()
  ...
  // 2. Filter logic based on Real Backend Statuses
  // Note: Backend statuses usually: OPEN, PENDING, IN_PROGRESS, RESOLVED
