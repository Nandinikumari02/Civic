              ...
              <TableRow key={issue.id} className="hover:bg-muted/30 transition-colors">
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    {issue.staff?.user ? (
                      <>
                        <div className="h-7 w-7 rounded-full bg-secondary flex items-center justify-center text-[10px] font-bold border">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Operational queue for <strong>{deptName}</strong> personnel.
            </p>
          </div>
        </div>
        <Button variant="outline" onClick={fetchData} className="gap-2 shadow-sm">
          <RefreshCcw className="h-4 w-4" /> Synchronize
        </Button>
      </div>
